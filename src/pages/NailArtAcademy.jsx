...
const NailArtAcademy = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);

  const courses = [
    { title: "Nail Art Training", desc: "Comprehensive training in nail extensions, gel polish, and creative nail art.", image: "https://images.unsplash.com/photo-1522337660859-02fbefca4702?auto=format&fit=crop&w=600&q=80" }
  ];
    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="relative h-[40vh] md:h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            Learn the intricate details of professional nail styling and extensions.
          </motion.p>
        </div>
      </div>
          ...
          {courses.map((course, idx) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <a href="https://wa.me/918903037766" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-rose-600 font-bold hover:text-rose-800">
      ...
      <div className="bg-rose-600 py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-rose-100 text-lg mb-10 max-w-2xl mx-auto">Join our Nail Art Academy today and become a certified professional.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="tel:+918903037766" className="px-8 py-4 bg-white text-rose-600 rounded-xl font-bold hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 shadow-xl">
